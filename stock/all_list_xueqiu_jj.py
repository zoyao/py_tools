...
for type in range(11, 21):
    index = 0
    while True:
        index += 1
        url = 'https://stock.xueqiu.com/v5/stock/screener/fund/list.json?page=' + str(index) + '&size=' + \
                str(max_size) + '&order=desc&order_by=percent&parent_type=1&type=' + str(type)
