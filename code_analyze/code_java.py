...
check_words['F'] = '自定义函数F'
check_words['G'] = '自定义函数G'
...
def function_analyze(name: str, code: str, is_xml: bool = False):
    if check_base_word is None or check_base_word in code:
        check = set()
        words = {}
